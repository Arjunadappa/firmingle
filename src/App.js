				...
				<div class="flex justify-between space-x-7">
					<div>
						<a href="#" class="flex items-center py-4 px-2">
							<img src={logo} alt="Logo" class="h-8 w-36 mr-2" />
						</a>
					</div>

					<div class="hidden md:flex basis-2/5 justify-between items-center ">
						<a
							href=""
						...
						<button class="py-2 px-2 text-gray-500 hover:text-white font-semibold  hover:bg-green-700 rounded-full transition duration-300 ">
							Contact Us
						</button>
					</div>
				</div>
